...
> Live-DB-Stand: **0001–0016 vollständig eingespielt** (0001–0009 verifiziert 2026-07-14, 0010–0015 vom Nutzer 2026-07-16/18, 0016 am 2026-07-22 — RPC-Probe: Aufruf mit `p_until` und `get_leaderboard_first_played` existieren und sind korrekt nur für `authenticated` freigegeben). Nichts mehr ausstehend. `apply_all.sql` dient der Vollinstallation frischer Projekte — auf der bestehenden Live-DB nichts erneut ausführen (0005 löscht Scores, der 0008-Backfill würde XP doppeln!).
