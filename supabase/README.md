...
> Live-DB-Stand: **0001–0009 vollständig eingespielt** (verifiziert 2026-07-14) — **0010 steht noch aus** (bis dahin läuft der Client graceful ohne fremde Avatare). `apply_all.sql` dient der Vollinstallation frischer Projekte — auf der bestehenden Live-DB nichts erneut ausführen (0005 löscht Scores, der 0008-Backfill würde XP doppeln!); für die Live-DB einfach nur den Inhalt von `0010_profile_avatars.sql` im SQL-Editor ausführen.
