...
> Live-DB-Stand: **0001–0009 vollständig eingespielt** (verifiziert 2026-07-14), **0010–0012 vom Nutzer eingespielt** (2026-07-16) — **0013 steht noch aus** (bis dahin bleibt die Disziplin-Reihenfolge im Cup-Aufklapp zufällig, sonst kein Fehler). `apply_all.sql` dient der Vollinstallation frischer Projekte — auf der bestehenden Live-DB nichts erneut ausführen (0005 löscht Scores, der 0008-Backfill würde XP doppeln!); für die Live-DB einfach den Inhalt von `0013_cup_leg_order.sql` im SQL-Editor ausführen.
